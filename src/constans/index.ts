...
const projects = [
  ...
  },
  {
    id: "2",
    name: "AEH",
    description: "Web-based platform that helps people with disabilities.",
    tags: [
      {
        id: "1",
        name: "react",
  ...
  },
  {
    ...
    name: "ai-webkraft",
    description:
      "Kreative und maßgeschneiderte Weblösungen mit Next.js, React und TypeScript. Wir verbinden Backend und Frontend nahtlos, setzen auf KI und Automatisierung und schaffen sichere, skalierbare digitale Erlebnisse. Lassen Sie uns gemeinsam Großartiges erschaffen!.",
    tags: [
      {
        id: "1",
        name: "react",
